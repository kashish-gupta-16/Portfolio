// import { Linkedin, Github, Cpu, Terminal, ArrowRight, Sparkles } from 'lucide-react';
...
//             <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-[10px] font-black uppercase tracking-[0.2em] rounded-full">
//               <Sparkles className="w-3 h-3" /> Digital Architect & Engineer
//             </div>
//             <h3 className="text-6xl lg:text-8xl font-black leading-[0.85] tracking-tighter">
//               KASHISH GUPTA<br />
...
//               Web.
//             </h3>
//             <p className="text-xl text-slate-400 leading-relaxed font-medium max-w-lg mx-auto lg:mx-0">
//               I'm a full-stack developer specialized in crafting high-performance, accessible, and
...
//             <div className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] text-center lg:text-left">
//               Connect & Solve
//             </div>
//             <div className="flex flex-wrap justify-center lg:justify-start gap-3">
//               <a
//                 href="https://www.linkedin.com/in/kashish-g-22b3a730a/"
//                 className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-slate-900 border border-slate-800 hover:border-[#0077B5] hover:bg-[#0077B5]/10 transition-all group"
//               >
...
//                 className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-slate-900 border border-slate-800 hover:border-white hover:bg-white/10 transition-all group"
//               >
...
//                 className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-slate-900 border border-slate-800 hover:border-[#FFA116] hover:bg-[#FFA116]/10 transition-all group"
//               >
//                 <div className="text-slate-400 group-hover:text-[#FFA116]">
//                   <LeetCodeIcon />
//                 </div>
//                 <span className="text-xs font-bold uppercase">LeetCode</span>
//               </a>
//               <a
//                 href="https://www.hackerrank.com/profile/kash8604gupta"
//                 className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-slate-900 border border-slate-800 hover:border-[#2EC866] hover:bg-[#2EC866]/10 transition-all group"
//               >
//                 <div className="text-slate-400 group-hover:text-[#2EC866]">
//                   <HackerRankIcon />
//                 </div>
//                 <span className="text-xs font-bold uppercase">HackerRank</span>
//               </a>
//             </div>
//           </div>
...
//               className="group flex items-center gap-3 px-10 py-5 bg-indigo-600 text-white rounded-[2rem] font-black transition-all hover:bg-indigo-500 shadow-2xl shadow-indigo-600/30 w-full sm:w-auto justify-center"
//             >
//               View Projects{' '}
...
//               className="text-sm font-black uppercase tracking-widest text-slate-400 hover:text-white transition-colors underline decoration-indigo-500 decoration-2 underline-offset-8"
//             >
//               Get in touch
//             </button>
//           </div>
...
//           <div className="relative aspect-square bg-slate-900/50 backdrop-blur-3xl border border-slate-800 rounded-[4rem] p-10 flex flex-col justify-between overflow-hidden shadow-3xl group">
...
//                 <Cpu className="w-10 h-10 group-hover:scale-110 transition-transform duration-500" />
//               </div>
//               <div className="text-right">
//                 <div className="text-[10px] font-black text-slate-500 uppercase tracking-widest">
//                   System Status
//                 </div>
//                 <div className="flex items-center gap-2 justify-end text-green-500 text-sm font-bold">
...
//                 {['React 19', 'TypeScript', 'Next.js'].map((tag) => (
//                   <span
//                     key={tag}
//                     className="px-3 py-1 bg-slate-800 rounded-lg text-[10px] font-bold text-slate-400"
//                   >
//                     {tag}
//                   </span>
//                 ))}
